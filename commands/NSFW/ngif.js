...
class NSFWGifCommand extends Command {
    constructor() {
        super('nsfwgif', {
            aliases: ['nsfwgif', 'ngif'],
            category: 'NSFW'
        });
        this.name = "nsfwgif"
        this.description = "Get a random nsfw gif"
        this.usage = "nsfwgif"
        this.example = "nsfwgif"
    }
    ...
    async exec(message) {
        ...
        let output = new MessageEmbed()
            .setColor('#eb6449')
            .setTitle(`NSFW Gif - Loading... :satellite:`)
            .setFooter(
