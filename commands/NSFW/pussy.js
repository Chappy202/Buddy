...
class PussyNSFWCommand extends Command {
    constructor() {
        super('pussy', {
            aliases: ['pussy'],
            category: 'NSFW'
        ...
        this.name = "pussy"
        this.description = "Get a random pussy image/gif"
        this.usage = "pussy"
        this.example = "pussy"
    }
    ...
    async exec(message) {
        ...
        let output = new MessageEmbed()
            .setColor('#eb6449')
            .setTitle(`NSFW Pussy - Loading... :satellite:`)
            .setFooter(
...
module.exports = PussyNSFWCommand;